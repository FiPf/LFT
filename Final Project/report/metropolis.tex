...
In order to give correct results, the Markov chain must be aperiodic, i.e. be able to reach all configurations in the configuration space. This is the case iff the transition matrix $T(U|U')$ is positive-semidefinite. This property is called strong ergodicity \cite{GattingerLang}. 
