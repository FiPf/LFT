...
\end{itemize}
The leapfrog integration method fulfills these requirements, as will be shown in the following. Leapfrog is a second-order method, compared to the very-well known first-order Euler method. It provieds a higher accuracy while maintaining measure invariance and reversibility.  
\\
