...
$\phi^4$ thery in two dimensions. All of this chaper is based on this paper: \cite{De_2005}. \\\\
...
interpolate between distinct classical vacua are not allowed, because peridiocity enforces $\phi(0) = \phi(L)$. \\
...
\end{equation}
In the broken phase, the renomalized coupling can then be defined as 
\begin{equation}
