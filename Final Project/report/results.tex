...
\begin{itemize}
    ...
    \item \textbf{Main Notebook: }The main file is a Jupyter Notebook, where all of the results are displayed. It accesses the other files through the packages described above. 
\end{itemize}
